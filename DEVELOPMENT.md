...
```bash
git remote add encore encore://teknisi-komputer-blog-z8hi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/teknisi-komputer-blog-z8hi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/teknisi-komputer-blog-z8hi/settings/integrations/github)
