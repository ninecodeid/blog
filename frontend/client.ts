...
import { deleteArticle as api_blog_delete_deleteArticle } from "~backend/blog/delete";
...
export namespace blog {
    ...
    export class ServiceClient {
         ...
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_blog_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/articles/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
